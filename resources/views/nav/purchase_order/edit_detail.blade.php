...
<form class="form" action="/nav/purchase_order/{{$data_t_po_detail->id}}/update_detail" method="POST">
...
<a href="/nav/purchase_order" class="btn btn-secondary btn-lg btn-block">Kembali</a>
</div>
